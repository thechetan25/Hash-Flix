$(document).ready(function () {
  ...
  $("#crime .owl-carousel").owlCarousel({
    loop: false,
    margin: 10,
    nav: false,
    items: 7,
  ...
  $("#crime .owl-next").click(function () {
    $("#crime .owl-carousel").trigger("next.owl.carousel");
  });
  $("#crime .owl-prev").click(function () {
    $("#crime .owl-carousel").trigger("prev.owl.carousel");
  });
